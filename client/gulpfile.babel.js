...
function clean(done) {
    rimraf(PATHS.distStatic, done);
    rimraf(PATHS.distHtml, done);
}
...
function images() {
    ...
    .pipe(gulp.dest(PATHS.distStatic + '/img'));
}

// Start a server with BrowserSync to preview the site in
function server(done) {
    browser.init({
        // server: [PATHS.distHtml, PATHS.distStatic],
        server: {
            baseDir: PATHS.distStatic,
            index: PATHS.distHtml + '/index.html'
        },
        port: PORT
    });
    done();
